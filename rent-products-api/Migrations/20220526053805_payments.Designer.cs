...
namespace rent_products_api.Migrations
{
    ...
    [Migration("20220526053805_payments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rent_products_api.DataLayer.Models.Payments.Payment", b =>
                {
                    b.HasOne("rent_products_api.DataLayer.Models.Rent", "ForRent")
                        .WithOne("Payment")
                        .HasForeignKey("rent_products_api.DataLayer.Models.Payments.Payment", "ForRentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ForRent");
                });
